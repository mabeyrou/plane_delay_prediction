...
class AirportBase(BaseModel):
    ...
    state_name: str = Field(..., min_length=1, le=100)
...
class AirportUpdate(BaseModel):
    ...
    airport_tech_id: Optional[int] = Field(None, min_length=10000, max_length=99999)
    airport_seq_id: Optional[int] = Field(None, min_length=1000000, max_length=9999999)
    city_market_id: Optional[int] = Field(None, min_length=10000, max_length=99999)
    ...
    state_fips: Optional[int] = Field(None, min_length=1, max_length=100)
    state_name: Optional[str] = Field(None, min_length=1, max_length=100)
    wac_code: Optional[int] = Field(None, min_length=1, max_length=100)
